...
<form role="search" method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ) ?>">
    <input type="text" name="s" class="search" placeholder="<?php echo $translate['search-placeholder']; ?>" value="<?php echo get_search_query() ?>">
    <input type="submit" value="<?php echo $translate['search-btn']; ?>" />
</form>